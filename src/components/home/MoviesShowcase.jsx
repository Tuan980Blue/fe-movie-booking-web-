                  ...
                  <div className="absolute inset-0 bg-black/55 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute inset-0 p-3 flex flex-col items-center justify-center text-white">
                      <div className="w-full max-w-[200px] space-y-2.5">
                        <Link to={`/movies/${m.id}`} className="block w-full text-center text-sm font-extrabold tracking-wide bg-[#a64bd6] hover:bg-[#9340c5] text-white rounded-md py-2">> CHI TIẾT</Link>
                        <Link to={`/user/booking/${m.id}`} className="block w-full text-center text-sm font-extrabold tracking-wide bg-pink-500 text-white hover:bg-neutral-lightGray rounded-md py-2">MUA VÉ</Link>
                      </div>
                    </div>
                  </div>
                </div>
